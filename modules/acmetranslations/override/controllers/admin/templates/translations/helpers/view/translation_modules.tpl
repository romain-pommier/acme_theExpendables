                      ...
                      {if !empty($newLang)}
                          ...
                          {/if}
                                ...
                                {foreach $newLang as $key => $value}{counter}
                                        ...
                                        {/if}
																			<a href="{$link->getAdminLink('AcmeTranslationsController')|escape:'htmlall':'utf-8'}&lang={$lang}&type={$type}&theme={$theme}&stringtotranslate={$key|stripslashes}" class="translate btn btn-default pull-right" data-translatelang="{$lang}" data-translate="{$key|stripslashes}" {l mod='acmetranslations'}>{l s='Traduire'}</a>
