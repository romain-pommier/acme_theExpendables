...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'mysql-maximilienpater.alwaysdata.net', 'port' => '', 'dbname' => 'maximilienpater_prestashop', 'user' => '161828', 'password' => 'Florence31250', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('KJAAGzpOjjmmm4CI1mIIqTxYfcUAkdUN8SXyid18bYbD9oVSvEG95fjA'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('KJAAGzpOjjmmm4CI1mIIqTxYfcUAkdUN8SXyid18bYbD9oVSvEG95fjA');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_host' => 'mysql-maximilienpater.alwaysdata.net',
            'database_port' => '',
            'database_name' => 'maximilienpater_prestashop',
            'database_user' => '161828',
            'database_password' => 'Florence31250',
            'database_prefix' => 'ps_',
            ...
            'kernel.secret' => 'KJAAGzpOjjmmm4CI1mIIqTxYfcUAkdUN8SXyid18bYbD9oVSvEG95fjA',
